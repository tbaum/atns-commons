...
// -------------------------- OTHER METHODS --------------------------
     ...
     * @param <R>           The result type.
     * @param action        The action.
     * @param allowRollback If <code>true</code>, any failure in the surrounding
     *                      execution will trigger a rollback of the action.
     * @return The result.
     * @throws ActionException
     */
    <R extends Result> R execute(Action<R> action, boolean allowRollback) throws ActionException;
}
