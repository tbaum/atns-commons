...
public interface PersistenceConfiguration {
     ...
     * {@link com.google.inject.persist.TransactionStrategyBuilder} {@code forAll(...)} methods.
     * <p>
     * When the list is empty, this means the defaults are in effect. These can be found in the
     * {@link com.google.inject.persist.Defaults} class. We always match on any class, and any method with the
     ...
     * {@link com.google.inject.persist.PersistenceMatchers} class.
     * 
