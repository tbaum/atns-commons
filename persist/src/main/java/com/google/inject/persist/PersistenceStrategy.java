...
import com.google.inject.persist.spi.PersistenceConfiguration;
import com.google.inject.persist.spi.PersistenceModule;
...
public interface PersistenceStrategy {
    /**
     * Produces a {@link com.google.inject.persist.spi.PersistenceModule}
     * from the given configuration.
     * 
     * @param config all configuration gathered through the public fluent interface API
     * @return the {@link com.google.inject.persist.spi.PersistenceModule} containing all
