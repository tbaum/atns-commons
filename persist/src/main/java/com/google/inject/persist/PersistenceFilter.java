...
import com.google.inject.persist.internal.ExceptionalRunnable;
import com.google.inject.persist.internal.Lifecycle;
import com.google.inject.persist.internal.LifecycleAdapter;
import com.google.inject.persist.internal.Lifecycles;
 ...
 * <p>
 * To be able to use {@link com.google.inject.persist.UnitOfWork#REQUEST}, register this filter <b>once</b> in the
 ...
 *   <filter-class>com.google.inject.persist.PersistenceFilter</filter-class>
 * </filter>
 *
 * <filter-mapping>
 *   <filter-name>persistenceFilter</filter-name>
 ...
 * {@link com.google.inject.persist.PersistenceService} instances will automatically start when they first get used.
...
public class PersistenceFilter implements Filter {
    ...
    /**
     * Starts all registered {@link com.google.inject.persist.PersistenceService} instances.
    ...
    /**
     * Stops all registered {@link com.google.inject.persist.PersistenceService} instances.
     */
    public void destroy() {
     ...
     * {@link com.google.inject.persist.PersistenceService} here
     * at configuration time if they support {@link UnitOfWork#REQUEST}.
