...
public class AtnsNamingStrategy extends DefaultNamingStrategy implements NamingStrategy {
    ...
    @Override public String classToTableName(final String s) {
        return tableName(super.classToTableName(removeImpl(s)));
    }

    @Override public String propertyToColumnName(final String s) {
        return super.propertyToColumnName(s);
    }

    @Override public String tableName(final String s) {
        return super.tableName(s);
    }

    @Override public String columnName(final String s) {
        return super.columnName(s);
    }

    @Override public String collectionTableName(final String s, final String s1, final String s2, final String s3,
                                                final String s4) {
        return super.collectionTableName(s, s1, s2, s3, s4);
    }

    @Override public String joinKeyColumnName(final String s, final String s1) {
        return super.joinKeyColumnName(s, s1);
    }

    @Override public String foreignKeyColumnName(final String s, final String s1, final String s2, final String s3) {
        return super.foreignKeyColumnName(s, s1, s2, s3);
    }

    @Override public String logicalColumnName(final String s, final String s1) {
    ...
    @Override public String logicalCollectionColumnName(final String s, final String s1, final String s2) {
