 ...
 * @since 18.11.10
 */
public abstract class ModuleLoaderImpl<T extends WidgetPresenter & PlacePresenter> implements ModuleLoader, RunAsyncCallback {
// ------------------------------ FIELDS ------------------------------
...
// --------------------------- CONSTRUCTORS ---------------------------
    ...
    public ModuleLoaderImpl(SharedServices sharedServices) {
