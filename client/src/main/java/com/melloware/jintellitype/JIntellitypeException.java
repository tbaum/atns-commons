...
public class JIntellitypeException extends RuntimeException {
	...
	public JIntellitypeException(final String aMessage, final Throwable aCause) {
		super(aMessage, aCause);
	}

	
	public JIntellitypeException(final String aMessage) {
		super(aMessage);
	}


	public JIntellitypeException(final Throwable aCause) {
		super(aCause);
	}
