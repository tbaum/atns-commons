...
public final class JIntellitype implements JIntellitypeConstants {
    ...
    */
   public void addIntellitypeListener(final IntellitypeListener listener) {
    ...
    */
   public void registerHotKey(final int identifier, final int modifier, final int keycode) {
      try {
    ...
    * @param keycode the key to respond to in Ascii integer, 65 for A
    */
   public void registerSwingHotKey(final int identifier, final int modifier, final int keycode) {
      try {
    ...
    */
   public void registerHotKey(final int identifier, final String modifierAndKeyCode) {
      final String[] split = modifierAndKeyCode.split("\\+");
      int mask = 0;
    ...
    */
   public void removeIntellitypeListener(final IntellitypeListener listener) {
    ...
    */
   public void unregisterHotKey(final int identifier) {
      try {
    ...
    */
   public static boolean checkInstanceAlreadyRunning(final String appTitle) {
    ...
    */
   public static void setLibraryLocation(final String libraryLocation) {
    ...
    */
   protected static int swingToIntelliType(final int swingKeystrokeModifier) {
      int mask = 0;
